...
export class CreateIncendioSeguidores1764363028015 implements MigrationInterface {
    name = 'CreateIncendioSeguidores1764363028015'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "incendios" ("incendio_uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "requiere_aprobacion" boolean NOT NULL DEFAULT true, "aprobado" boolean NOT NULL DEFAULT false, "aprobado_en" TIMESTAMP WITH TIME ZONE, "rechazado_en" TIMESTAMP WITH TIME ZONE, "motivo_rechazo" text, "titulo" text, "descripcion" text, "centroide" geometry(Point,4326), "reportado_por_nombre" text, "telefono" text, "reportado_en" TIMESTAMP WITH TIME ZONE, "lugar_poblado" text, "finca" text, "extinguido_at" TIMESTAMP WITH TIME ZONE, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, "creado_por_uuid" uuid NOT NULL, "aprobado_por" uuid, "rechazado_por" uuid, "estado_incendio_uuid" uuid NOT NULL, "reportado_por_uuid" uuid, "institucion_reporte_uuid" uuid, "medio_uuid" uuid, "departamento_uuid" uuid, "municipio_uuid" uuid, CONSTRAINT "PK_6c7b9e2d55a7b6ae15449667281" PRIMARY KEY ("incendio_uuid"))`);
        await queryRunner.query(`CREATE INDEX "idx_incendios_municipio" ON "incendios" ("municipio_uuid") `);
        await queryRunner.query(`CREATE INDEX "idx_incendios_departamento" ON "incendios" ("departamento_uuid") `);
        await queryRunner.query(`CREATE INDEX "idx_incendios_reportado_en" ON "incendios" ("reportado_en") `);
        ...
        await queryRunner.query(`CREATE TABLE "cierre_plantillas" ("plantilla_uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "nombre" text NOT NULL, "descripcion" text, "activa" boolean NOT NULL DEFAULT false, "version" integer NOT NULL DEFAULT '1', "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, "creado_por_uuid" uuid NOT NULL, CONSTRAINT "PK_bd4d39b05769b34d8560fc33341" PRIMARY KEY ("plantilla_uuid"))`);
        await queryRunner.query(`CREATE INDEX "idx_cierre_plantillas_activa" ON "cierre_plantillas" ("activa") `);
        await queryRunner.query(`CREATE TABLE "cierre_secciones" ("seccion_uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "plantilla_uuid" uuid NOT NULL, "nombre" text NOT NULL, "descripcion" text, "orden" integer NOT NULL, "icono" text, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_65142e15348403443ff8d2794af" PRIMARY KEY ("seccion_uuid"))`);
        await queryRunner.query(`CREATE INDEX "idx_cierre_secciones_plantilla" ON "cierre_secciones" ("plantilla_uuid") `);
        ...
        await queryRunner.query(`CREATE TABLE "cierre_campos" ("campo_uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "seccion_uuid" uuid NOT NULL, "campo_padre_uuid" uuid, "nombre" text NOT NULL, "descripcion" text, "placeholder" text, "tipo" text NOT NULL, "orden" integer NOT NULL, "requerido" boolean NOT NULL DEFAULT false, "opciones" jsonb, "validaciones" jsonb, "dependencias" jsonb, "unidad" text, "ayuda" text, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_a3dc2e26628dcd3634f105b7369" PRIMARY KEY ("campo_uuid"))`);
        await queryRunner.query(`CREATE INDEX "idx_cierre_campos_campo_padre" ON "cierre_campos" ("campo_padre_uuid") `);
        await queryRunner.query(`CREATE INDEX "idx_cierre_campos_seccion" ON "cierre_campos" ("seccion_uuid") `);
        await queryRunner.query(`CREATE TABLE "cierre_respuestas" ("respuesta_uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "incendio_uuid" uuid NOT NULL, "campo_uuid" uuid NOT NULL, "valor_texto" text, "valor_numero" numeric, "valor_fecha" date, "valor_datetime" TIMESTAMP WITH TIME ZONE, "valor_boolean" boolean, "valor_json" jsonb, "respondido_por_uuid" uuid NOT NULL, "creado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "actualizado_en" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "eliminado_en" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_3217fca24d7f69182767dc0af83" PRIMARY KEY ("respuesta_uuid"))`);
        await queryRunner.query(`CREATE INDEX "idx_cierre_respuestas_campo" ON "cierre_respuestas" ("campo_uuid") `);
        await queryRunner.query(`CREATE INDEX "idx_cierre_respuestas_incendio" ON "cierre_respuestas" ("incendio_uuid") `);
        ...
        await queryRunner.query(`ALTER TABLE "incendios" ADD CONSTRAINT "fk_incendios_reportado_por_uuid" FOREIGN KEY ("reportado_por_uuid") REFERENCES "usuarios"("usuario_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "incendios" ADD CONSTRAINT "fk_incendios_institucion_reporte_uuid" FOREIGN KEY ("institucion_reporte_uuid") REFERENCES "instituciones"("institucion_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "incendios" ADD CONSTRAINT "fk_incendios_medio_uuid" FOREIGN KEY ("medio_uuid") REFERENCES "medios"("medio_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "incendios" ADD CONSTRAINT "fk_incendios_departamento_uuid" FOREIGN KEY ("departamento_uuid") REFERENCES "departamentos"("departamento_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "incendios" ADD CONSTRAINT "fk_incendios_municipio_uuid" FOREIGN KEY ("municipio_uuid") REFERENCES "municipios"("municipio_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cierre_plantillas" ADD CONSTRAINT "fk_cierre_plantillas_creado_por" FOREIGN KEY ("creado_por_uuid") REFERENCES "usuarios"("usuario_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cierre_secciones" ADD CONSTRAINT "fk_cierre_secciones_plantilla" FOREIGN KEY ("plantilla_uuid") REFERENCES "cierre_plantillas"("plantilla_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "cierre_campos" ADD CONSTRAINT "fk_cierre_campos_seccion" FOREIGN KEY ("seccion_uuid") REFERENCES "cierre_secciones"("seccion_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cierre_campos" ADD CONSTRAINT "fk_cierre_campos_campo_padre" FOREIGN KEY ("campo_padre_uuid") REFERENCES "cierre_campos"("campo_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cierre_respuestas" ADD CONSTRAINT "fk_cierre_respuestas_incendio" FOREIGN KEY ("incendio_uuid") REFERENCES "incendios"("incendio_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cierre_respuestas" ADD CONSTRAINT "fk_cierre_respuestas_campo" FOREIGN KEY ("campo_uuid") REFERENCES "cierre_campos"("campo_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cierre_respuestas" ADD CONSTRAINT "fk_cierre_respuestas_respondido_por" FOREIGN KEY ("respondido_por_uuid") REFERENCES "usuarios"("usuario_uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cierre_respuestas" DROP CONSTRAINT "fk_cierre_respuestas_respondido_por"`);
        await queryRunner.query(`ALTER TABLE "cierre_respuestas" DROP CONSTRAINT "fk_cierre_respuestas_campo"`);
        await queryRunner.query(`ALTER TABLE "cierre_respuestas" DROP CONSTRAINT "fk_cierre_respuestas_incendio"`);
        await queryRunner.query(`ALTER TABLE "cierre_campos" DROP CONSTRAINT "fk_cierre_campos_campo_padre"`);
        await queryRunner.query(`ALTER TABLE "cierre_campos" DROP CONSTRAINT "fk_cierre_campos_seccion"`);
        await queryRunner.query(`ALTER TABLE "cierre_secuencia_control" DROP CONSTRAINT "fk_cierre_secuencia_incendio_uuid"`);
        await queryRunner.query(`ALTER TABLE "cierre_secciones" DROP CONSTRAINT "fk_cierre_secciones_plantilla"`);
        await queryRunner.query(`ALTER TABLE "cierre_plantillas" DROP CONSTRAINT "fk_cierre_plantillas_creado_por"`);
        ...
        await queryRunner.query(`ALTER TABLE "incendios" DROP CONSTRAINT "fk_incendios_municipio_uuid"`);
        await queryRunner.query(`ALTER TABLE "incendios" DROP CONSTRAINT "fk_incendios_departamento_uuid"`);
        await queryRunner.query(`ALTER TABLE "incendios" DROP CONSTRAINT "fk_incendios_medio_uuid"`);
        await queryRunner.query(`ALTER TABLE "incendios" DROP CONSTRAINT "fk_incendios_institucion_reporte_uuid"`);
        await queryRunner.query(`ALTER TABLE "incendios" DROP CONSTRAINT "fk_incendios_reportado_por_uuid"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_cierre_respuestas_incendio"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cierre_respuestas_campo"`);
        await queryRunner.query(`DROP TABLE "cierre_respuestas"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cierre_campos_seccion"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cierre_campos_campo_padre"`);
        await queryRunner.query(`DROP TABLE "cierre_campos"`);
        await queryRunner.query(`DROP TABLE "cierre_secuencia_control"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cierre_secciones_plantilla"`);
        await queryRunner.query(`DROP TABLE "cierre_secciones"`);
        await queryRunner.query(`DROP INDEX "public"."idx_cierre_plantillas_activa"`);
        await queryRunner.query(`DROP TABLE "cierre_plantillas"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_incendios_reportado_en"`);
        await queryRunner.query(`DROP INDEX "public"."idx_incendios_departamento"`);
        await queryRunner.query(`DROP INDEX "public"."idx_incendios_municipio"`);
